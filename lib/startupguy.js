...
*/
	...
	_replyWithStartup: function (originalMessage) {
		...
		request('http://itsthisforthat.com/api.php?json', function (err, response, body) {
			...
			var channel = BeepBoop.prototype._getChannelById(originalMessage.channel);
		BeepBoop.prototype.postMessageToChannel(channel.name, info[0], { 'slackbot': true, username: 'Startup Guy', icon_emoji: ':startupbot:' });
	    });
	},
