...
*/
	...
	_replyWithStartup: function (originalMessage) {
		...
		request('http://itsthisforthat.com/api.php?json', function (err, response, body) {
			...
			return this.response = 'Butterflies';
//			var channel = Bot.prototype._getChannelById(originalMessage.channel);
//		Bot.prototype.postMessageToChannel(channel.name, info[0], { 'slackbot': true, username: 'Startup Guy', icon_emoji: ':startupbot:' });
	    });
	},
